...
public class PasswordUtil
{
    ...
    /**
     * Will shadow password values of arguments with "X" which names are given
     * in <tt>passwordArgs</tt> array in "sun.java.command" system property.
     * @param passwordArgs the array which contains the names of password
     *                     arguments to be shadowed.
     */
    static public void clearSunJavaCommandSysProperty(String[] passwordArgs)
    {
        String command = System.getProperty("sun.java.command");

        command = replacePasswords(command, passwordArgs);
